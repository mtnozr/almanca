...
const TRANSLATIONS = {
    tr: {
        ...
        progress: "İlerlemem",
        settings: "Ayarlar",
        introKicker: "Görev Başlıyor",
        introHeading: "Almanca Macerasına Hazır mısın?",
        introLead: "Roketini hazırla, kelimeleri yakala ve her turda yeni rozetler kazan.",
        introBadgeOne: "24+ tema",
        introBadgeTwo: "5 oyun modu",
        introBadgeThree: "Sesli öğrenme",
        introTipOneTitle: "Hız Turu ile ısın",
        introTipOneText: "60 saniyede mümkün olduğunca çok doğru yap.",
        introTipTwoTitle: "Yıldız topla",
        introTipTwoText: "Her bölümde doğru seri yakalayarak ekstra yıldız kazan.",
        introTipThreeTitle: "Sesini aç",
        introTipThreeText: "Doğru telaffuzu duyup tekrar ederek daha hızlı öğren.",
    ...
    de: {
        ...
        introKicker: "Mission startet",
        introHeading: "Bereit für das Deutsch-Abenteuer?",
        introLead: "Starte deine Rakete, sammle Wörter und gewinne in jeder Runde neue Abzeichen.",
        introBadgeOne: "24+ Themen",
        introBadgeTwo: "5 Spielmodi",
        introBadgeThree: "Lernen mit Ton",
        introTipOneTitle: "Mit Schnellrunde aufwärmen",
        introTipOneText: "Schaffe in 60 Sekunden so viele richtige Antworten wie möglich.",
        introTipTwoTitle: "Sterne sammeln",
        introTipTwoText: "Baue Serien auf und hol dir Extra-Sterne in jedem Level.",
        introTipThreeTitle: "Ton einschalten",
        introTipThreeText: "Höre die Aussprache und wiederhole für schnelleres Lernen.",
